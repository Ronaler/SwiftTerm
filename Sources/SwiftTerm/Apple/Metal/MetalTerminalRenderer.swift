...
final class MetalTerminalRenderer: NSObject, MTKViewDelegate {
    ...
    static let fpsLogEnabled = ProcessInfo.processInfo.environment["SWIFTTERM_METAL_FPS"] == "1"
#endif
...
#endif
#if DEBUG
        // Opt-in via SWIFTTERM_METAL_FPS=1: with many embedded terminals the
        // per-second print per renderer is itself noise/overhead.
